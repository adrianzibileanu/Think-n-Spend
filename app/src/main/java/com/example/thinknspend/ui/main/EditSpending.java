 ...
 * Use the {@link EditSpending#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EditSpending extends Fragment {
    ...
    public static EditSpending newInstance(String param1, String param2) {
        EditSpending fragment = new EditSpending();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_edit_spending, container, false);
        EditText edtDate = (EditText) v.findViewById(R.id.edtSpDate);
    ...
    // Apply the adapter to the spinner
        ...
        FloatingActionButton btn = (FloatingActionButton) v.findViewById(R.id.edtSp);
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View y)  {
                ...
                EditText edtName = (EditText) v.findViewById(R.id.edtSpName);
                spName = edtName.getText().toString();
                EditText edtAmount = (EditText) v.findViewById(R.id.edtSpAmount);


                spDate = edtDate.getText().toString();;
                Spinner spinCurrency = (Spinner) v.findViewById(R.id.edtSpCurrency);
               ...
               // System.out.println(sp.toString());
                //mf.setSpendingInfo(spAmount, spCurrency, spType, spName, spDate);
